...
$totalPages_reservasitampil = ceil($totalRows_reservasitampil/$maxRows_reservasitampil)-1;$maxRows_reservasitampil = 10;
$pageNum_reservasitampil = 0;
if (isset($_GET['pageNum_reservasitampil'])) {
  $pageNum_reservasitampil = $_GET['pageNum_reservasitampil'];
}
...
<table width="856" height="437" border="0" align="center">
  <tr>
    ...
    <td width="616"><ul id="MenuBar1" class="MenuBarHorizontal">
      <li><a href="#">Home</a>        </li>
      <li><a href="reservasicaricheck.php" class="MenuBarItemSubmenu">Reservasi</a>
        <ul>
          <li><a href="resepsioniscarinama1.php">CariNama</a></li>
          <li><a href="#">CariCheckIN</a></li>
        </ul>
      </li>
    </ul></td>
    <td width="88">&nbsp;</td>
