...
$logintamu = mysql_query($query_logintamu, $reservasihotel) or die(mysql_error());
...
if (isset($_POST['textfield3'])) {
  ...
  $MM_redirectLoginSuccess = "reservasi.php";
  $MM_redirectLoginFailed = "registrasiuser.php";
    ...
    <td colspan="2"><ul id="MenuBar1" class="MenuBarHorizontal">
      <li><a href="#" class="MenuBarItemSubmenu">Login</a>
        <ul>
          ...
          <li><a href="loginresepsionis.php">LoginResepsionis</a></li>
        </ul>
      </li>
    </ul></td>
  </tr>
  <tr>
    <td height="356" colspan="3"><form id="form4" name="form4" method="POST" action="<?php echo $loginFormAction; ?>">
      <table width="200" border="1" align="center">
        <tr>
          <td colspan="2" align="center">Login Tamu</td>
        </tr>
        <tr>
