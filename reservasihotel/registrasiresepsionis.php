...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO resepsionis (id_resepsionis, nama_resepsionis, username, password) VALUES (%s, %s, %s, %s)",
...
mysql_select_db($database_reservasihotel, $reservasihotel);
$query_registrasiresepsionis = "SELECT * FROM resepsionis";
$registrasiresepsionis = mysql_query($query_registrasiresepsionis, $reservasihotel) or die(mysql_error());
$row_registrasiresepsionis = mysql_fetch_assoc($registrasiresepsionis);
$totalRows_registrasiresepsionis = mysql_num_rows($registrasiresepsionis);
?>
...
<?php
mysql_free_result($registrasiresepsionis);
